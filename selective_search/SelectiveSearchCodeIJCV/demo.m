...
% figure;
% imshow(im);
% for i = 1: size(hBlobs,1);
%         rectangle('Position',[ hBlobs{i,1}.rect(1),hBlobs{i,1}.rect(2),hBlobs{i,1}.rect(3) - hBlobs{i,1}.rect(1)...
%             ,hBlobs{i,1}.rect(4)-hBlobs{i,1}.rect(2)],'edgecolor','r');
% 
% end
